...
public final class TextureGrid extends OptionRow<Object> {
    ...
    private void renderHolderPreview(int x, int y, PlayerPreviewEntity holder, float pt) {
        ...
        ModelPreviewRenderer.renderLivingEntityPreview(x + TEX_BTN_W / 2.0f, y + TEX_BTN_H / 2.0f + 24.0f, 35.0f, mc.getTimer().getGameTimeDeltaTicks(), holder, RendererManager.getPlayerRenderer(), false, true);
