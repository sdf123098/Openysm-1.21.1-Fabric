...
import static rip.ysm.zstd.BitInputStream.peekBits;
import static rip.ysm.zstd.Constants.COMPRESSED_BLOCK;
import static rip.ysm.zstd.Constants.COMPRESSED_LITERALS_BLOCK;
import static rip.ysm.zstd.Constants.DEFAULT_MAX_OFFSET_CODE_SYMBOL;
import static rip.ysm.zstd.Constants.LITERALS_LENGTH_BITS;
import static rip.ysm.zstd.Constants.LITERAL_LENGTH_TABLE_LOG;
import static rip.ysm.zstd.Constants.LONG_NUMBER_OF_SEQUENCES;
import static rip.ysm.zstd.Constants.MAGIC_NUMBER;
import static rip.ysm.zstd.Constants.MATCH_LENGTH_BITS;
import static rip.ysm.zstd.Constants.MATCH_LENGTH_TABLE_LOG;
import static rip.ysm.zstd.Constants.MAX_BLOCK_SIZE;
import static rip.ysm.zstd.Constants.MAX_LITERALS_LENGTH_SYMBOL;
import static rip.ysm.zstd.Constants.MAX_MATCH_LENGTH_SYMBOL;
import static rip.ysm.zstd.Constants.MIN_BLOCK_SIZE;
import static rip.ysm.zstd.Constants.MIN_SEQUENCES_SIZE;
import static rip.ysm.zstd.Constants.MIN_WINDOW_LOG;
import static rip.ysm.zstd.Constants.OFFSET_TABLE_LOG;
import static rip.ysm.zstd.Constants.RAW_BLOCK;
import static rip.ysm.zstd.Constants.RAW_LITERALS_BLOCK;
import static rip.ysm.zstd.Constants.RLE_BLOCK;
import static rip.ysm.zstd.Constants.RLE_LITERALS_BLOCK;
import static rip.ysm.zstd.Constants.SEQUENCE_ENCODING_BASIC;
import static rip.ysm.zstd.Constants.SEQUENCE_ENCODING_COMPRESSED;
import static rip.ysm.zstd.Constants.SEQUENCE_ENCODING_REPEAT;
import static rip.ysm.zstd.Constants.SEQUENCE_ENCODING_RLE;
import static rip.ysm.zstd.Constants.SIZE_OF_BLOCK_HEADER;
import static rip.ysm.zstd.Constants.SIZE_OF_BYTE;
import static rip.ysm.zstd.Constants.SIZE_OF_INT;
import static rip.ysm.zstd.Constants.SIZE_OF_LONG;
import static rip.ysm.zstd.Constants.SIZE_OF_SHORT;
import static rip.ysm.zstd.Constants.TREELESS_LITERALS_BLOCK;
import static rip.ysm.zstd.UnsafeUtil.UNSAFE;
import static rip.ysm.zstd.Util.fail;
import static rip.ysm.zstd.Util.get24BitLittleEndian;
import static rip.ysm.zstd.Util.mask;
import static rip.ysm.zstd.Util.verify;
